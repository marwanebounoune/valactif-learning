...
var AlpacaAdvanced = function() {
    ...
    var _componentAlpacaAdvanced = function() {
        ...
        $('#alpaca-option-tree-connector').alpaca({
            schemaSource: "{% static 'demo_data/alpaca/optiontree-custom-schema.json',
            optionsSource: "{% static 'demo_data/alpaca/optiontree-custom-options.json',
            options: {
                focus: false
            }
        });
