    ...
    var _componentPnotify = function() {
        ...
        $('#pnotify-custom-styled').on('click', function () {
            new PNotify({
                ...
                text: 'Check me out! I\'m a notice.',
                addclass: 'alert alert-teal alert-styled-left alert-styled-custom alert-arrow-left'
            });
        });
        ...
        $('#pnotify-solid-warning').on('click', function () {
            new PNotify({
                ...
                text: 'Check me out! I\'m a notice.',
                addclass: 'bg-warning border-warning text-white'
            });
        });
        ...
        $('#pnotify-solid-info').on('click', function () {
            new PNotify({
                title: 'Info notice',
                text: 'Check me out! I\'m a notice.',
                addclass: 'bg-info border-info text-white'
            });
        });
        ...
        $('#pnotify-solid-styled-left').on('click', function () {
            new PNotify({
                title: 'Left icon',
                text: 'Check me out! I\'m a notice.',
                addclass: 'alert bg-primary text-white border-primary alert-styled-left'
            });
        });
        ...
        $('#pnotify-desktop-default').on('click', function () {
            ...
            (new PNotify({
                ...
                desktop: {
                    ...
                    icon: "{% static 'images/pnotify/default.png'
                }
            })
        ...
        $('#pnotify-desktop-danger').on('click', function () {
            ...
            (new PNotify({
                ...
                desktop: {
                    desktop: true,
                    icon: "{% static 'images/pnotify/danger.png'
                }
            })
            ).get().click(function(e) {
                if ($('.ui-pnotify-closer, .ui-pnotify-sticker, .ui-pnotify-closer *, .ui-pnotify-sticker *').is(e.target)) return;
        ...
        $('#pnotify-desktop-success').on('click', function () {
            ...
            (new PNotify({
                ...
                desktop: {
                    desktop: true,
                    icon: "{% static 'images/pnotify/success.png'
                }
            })
            ).get().click(function(e) {
                if ($('.ui-pnotify-closer, .ui-pnotify-sticker, .ui-pnotify-closer *, .ui-pnotify-sticker *').is(e.target)) return;
        ...
        $('#pnotify-desktop-warning').on('click', function () {
            ...
            (new PNotify({
                ...
                desktop: {
                    desktop: true,
                    icon: "{% static 'images/pnotify/warning.png'
                }
            })
            ).get().click(function(e) {
                if ($('.ui-pnotify-closer, .ui-pnotify-sticker, .ui-pnotify-closer *, .ui-pnotify-sticker *').is(e.target)) return;
        ...
        $('#pnotify-desktop-info').on('click', function () {
            ...
            (new PNotify({
                ...
                desktop: {
                    desktop: true,
                    icon: "{% static 'images/pnotify/info.png'
                }
            })
            ).get().click(function(e) {
                if ($('.ui-pnotify-closer, .ui-pnotify-sticker, .ui-pnotify-closer *, .ui-pnotify-sticker *').is(e.target)) return;
            ...
            new PNotify({
                ...
                confirm: {
                    ...
                    buttons: [
                        ...
                        {
                            text: 'Fruit',
                            addClass: 'btn btn-sm btn-indigo',
                            click: function(notice) {
                                notice.update({
                                    title: 'You\'ve chosen a side',
                                    text: 'You want fruit.',
        ...
        $('#pnotify-switching').on('click', function () {
            new PNotify({
                ...
                addclass: 'alert bg-primary border-primary text-white alert-styled-right',
                before_close: function(PNotify) {
                    PNotify.update({
                        title: 'Error',
                        text: 'Uh oh. Now I\'ve become an error.',
                        addclass: 'alert bg-danger border-danger text-white alert-styled-right',
                        type: 'error',
                        before_close: function(PNotify) {
                            PNotify.update({
                                title: 'Success',
                                text: 'I fixed the error!',
                                addclass: 'alert bg-success border-success text-white alert-styled-right',
                                type: 'success',
                                before_close: function(PNotify) {
                                    PNotify.update({
                                        title: 'Info',
                                        text: 'Everything\'s cool now.',
                                        addclass: 'alert bg-info border-info text-white alert-styled-right',
                                        type: 'info',
                                        before_close: null
                                    });
                                    PNotify.queueRemove();
        ...
        $('#pnotify-dynamic').on('click', function () {
            ...
            var interval = setInterval(function() {
                ...
                if (percent >= 100) {
                    ...
                    options.title = "Done!";
                    options.addclass = "bg-success border-success text-white";
        ...
        function show_stack_top_left(type) {
            ...
            switch (type) {
                ...
                opts.addclass = "stack-top-left bg-danger border-danger text-white";
                opts.type = "error";
                break;
                ...
                opts.addclass = "stack-top-left bg-info border-info text-white";
                opts.type = "info";
                break;
                ...
                opts.addclass = "stack-top-left bg-success border-success text-white";
                opts.type = "success";
                break;
            }
            new PNotify(opts);
        ...
        function show_stack_bottom_left(type) {
            var opts = {
                title: "Over here",
                text: "Check me out. I'm in a different stack.",
                addclass: "stack-bottom-left bg-primary border-primary text-white",
            ...
            switch (type) {
                ...
                opts.title = "Oh No";
                opts.text = "Watch out for that water tower!";
                opts.addclass = "stack-bottom-left bg-danger border-danger text-white";
                opts.type = "error";
                break;
                ...
                opts.title = "Breaking News";
                opts.text = "Have you met Ted?";
                opts.addclass = "stack-bottom-left bg-info border-info text-white";
                opts.type = "info";
                break;
                ...
                opts.title = "Good News Everyone";
                opts.text = "I've invented a device that bites shiny metal asses.";
                opts.addclass = "stack-bottom-left bg-success border-success text-white";
                opts.type = "success";
                break;
            }
            new PNotify(opts);
        ...
        function show_stack_bottom_right(type) {
            var opts = {
                title: "Over here",
                text: "Check me out. I'm in a different stack.",
                addclass: "stack-bottom-right bg-primary border-primary text-white",
            ...
            switch (type) {
                ...
                opts.title = "Oh No";
                opts.text = "Watch out for that water tower!";
                opts.addclass = "stack-bottom-right bg-danger border-danger text-white";
                opts.type = "error";
                break;
                ...
                opts.title = "Breaking News";
                opts.text = "Have you met Ted?";
                opts.addclass = "stack-bottom-right bg-info border-info text-white";
                opts.type = "info";
                break;
                ...
                opts.title = "Good News Everyone";
                opts.text = "I've invented a device that bites shiny metal asses.";
                opts.addclass = "stack-bottom-right bg-success border-success text-white";
                opts.type = "success";
                break;
            }
            new PNotify(opts);
        ...
        function show_stack_custom_left(type) {
            var opts = {
                title: "Over here",
                text: "Check me out. I'm in a different stack.",
                addclass: "stack-custom-left bg-primary border-primary alert-styled-right text-white",
            ...
            switch (type) {
                ...
                opts.title = "Oh No";
                opts.text = "Watch out for that water tower!";
                opts.addclass = "stack-custom-left bg-danger border-danger text-white";
                opts.type = "error";
                break;
                ...
                opts.title = "Breaking News";
                opts.text = "Have you met Ted?";
                opts.addclass = "stack-custom-left bg-info border-info text-white";
                opts.type = "info";
                break;
                ...
                opts.title = "Good News Everyone";
                opts.text = "I've invented a device that bites shiny metal asses.";
                opts.addclass = "stack-custom-left bg-success border-success text-white";
                opts.type = "success";
                break;
            }
            new PNotify(opts);
        ...
        function show_stack_custom_right(type) {
            var opts = {
                title: "Over here",
                text: "Check me out. I'm in a different stack.",
                addclass: "stack-custom-right bg-primary border-primary text-white",
            ...
            switch (type) {
                ...
                opts.title = "Oh No";
                opts.text = "Watch out for that water tower!";
                opts.addclass = "stack-custom-right bg-danger border-danger text-white";
                opts.type = "error";
                break;
                ...
                opts.title = "Breaking News";
                opts.text = "Have you met Ted?";
                opts.addclass = "stack-custom-right bg-info border-info text-white";
                opts.type = "info";
                break;
                ...
                opts.title = "Good News Everyone";
                opts.text = "I've invented a device that bites shiny metal asses.";
                opts.addclass = "stack-custom-right bg-success border-success text-white";
                opts.type = "success";
                break;
            }
            new PNotify(opts);
        ...
        function show_stack_custom_top(type) {
            var opts = {
                ...
                addclass: "stack-custom-top bg-primary border-primary text-white",
        ...
        function show_stack_custom_bottom(type) {
            ...
            switch (type) {
                ...
                opts.title = "Oh No";
                opts.text = "Watch out for that water tower!";
                opts.addclass = "stack-custom-bottom bg-danger border-danger text-white";
                opts.type = "error";
                break;
                ...
                opts.title = "Breaking News";
                opts.text = "Have you met Ted?";
                opts.addclass = "stack-custom-bottom bg-info border-info text-white";
                opts.type = "info";
                break;
                ...
                opts.title = "Good News Everyone";
                opts.text = "I've invented a device that bites shiny metal asses.";
                opts.addclass = "stack-custom-bottom bg-success border-success text-white";
                opts.type = "success";
                break;
            }
            new PNotify(opts);
