...
var Fancytree = function() {
    ...
    var _componentFancytree = function() {
        ...
        $('.tree-ajax').fancytree({
            source: {
                url: "{% static 'demo_data/fancytree/fancytree.json'
            },
            init: function(event, data) {
                $('.has-tooltip .fancytree-title').tooltip();
            }
        ...
        $('.tree-table').fancytree({
            ...
            renderColumns: function(event, data) {
                ...
                $tdList.eq(4).addClass('text-center').html('<label class="custom-control custom-checkbox"><input type="checkbox" class="custom-control-input" name="like" value="' + node.key + '"><span class="custom-control-label p-0"></span></label>');
            }
        });
