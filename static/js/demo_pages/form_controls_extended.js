...
var ExtendedFormControls = function() {
    ...
    var _componentMaxlength = function() {
        ...
        $('.maxlength-badge-position').maxlength({
            ...
            warningClass: 'text-success left-auto right-0 top-50 translate-middle-y pr-2 mr-1',
            limitReachedClass: 'text-danger left-auto right-0 top-50 translate-middle-y pr-2 mr-1',
    ...
    var _componentTypeahead = function() {
        ...
        var bestPictures = new Bloodhound({
            ...
            remote: "{% static 'json/queries/%QUERY.json'
        });
