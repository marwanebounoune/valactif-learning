...
var JqueryUiForms = function() {
    ...
    var _componentUiDatepicker = function() {
        ...
        $('.datepicker-icon').datepicker({
            showOn: 'button',
            buttonImage: "{% static 'images/ui/datepicker_trigger.png',
    ...
    var _componentUiAutocomplete = function() {
        ...
        // Append to scrollable area
        $.extend($.ui.autocomplete.prototype.options, { appendTo: '.content-inner' });
        ...
        $('#ac-caching').autocomplete({
            ...
            source: function(request, response) {
                ...
                $.getJSON("{% static 'demo_data/jquery_ui/autocomplete.php', request, function(data, status, xhr) {
                    cache[ term ] = data;
                    response(data);
                });
            },
    ...
    var _componentUiSelectmenu = function() {
        ...
        // Append to scrollable area
        $.extend($.ui.selectmenu.prototype.options, { appendTo: '.content-inner' });
