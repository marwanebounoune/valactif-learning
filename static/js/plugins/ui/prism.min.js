/* PrismJS 1.23.0
https://prismjs.com/download.html#themes=prism-coy&languages=markup+css+clike+javascript+c+csharp+cpp+css-extras+git+haml+handlebars+js-extras+json+json5+jsonp+js-templates+less+markdown+markup-templating+php+python+regex+ruby+sass+scss+sql+typescript&plugins=line-highlight+line-numbers+normalize-whitespace+toolbar+copy-to-clipboard */
